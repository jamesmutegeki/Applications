  ...
  return (
    <section className="py-16 lg:py-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <Link to="/practice-areas" className="inline-flex items-center gap-2 text-sm text-neutral-600 dark:text-neutral-400 hover:text-navy-700 mb-6">
          <ArrowLeft size={16} /> Back to Practice Areas
        </Link>
        <div className="flex items-start gap-4 mb-6">
          <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${area.color} flex items-center justify-center`}>
            <Icon size={28} className="text-white" />
          </div>
          <div>
            <h1 className="font-serif text-3xl lg:text-4xl font-bold text-navy-800 dark:text-white">{area.title}</h1>
    ...
    <>
      <section className="bg-navy-900 py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span className="text-sm font-medium text-gold-400 uppercase tracking-wider">Our Expertise</span>
            ...
            {practiceAreas.map((area) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="font-semibold text-lg text-navy-800 dark:text-white mb-2">{area.title}</h3>
