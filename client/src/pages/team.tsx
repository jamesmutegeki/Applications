    ...
    <>
      <section className="bg-navy-900 py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span className="text-sm font-medium text-gold-400 uppercase tracking-wider">Our People</span>
              ...
              >
                <div className="relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-5 gap-3">
                    <a href={`mailto:${attorney.email}`} className="w-10 h-10 rounded-full bg-white/90 flex items-center justify-center hover:bg-gold-400 transition-colors">
                      <Mail size={16} className="text-navy-900" />
                    </a>
                    <a href={`tel:${attorney.phone}`} className="w-10 h-10 rounded-full bg-white/90 flex items-center justify-center hover:bg-gold-400 transition-colors">
                      <Phone size={16} className="text-navy-900" />
                    </a>
                  </div>
                </div>
                <div className="p-5">
                  <h3 className="font-semibold text-lg text-navy-800 dark:text-white">{attorney.name}</h3>
