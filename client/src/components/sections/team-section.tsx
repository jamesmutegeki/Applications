    ...
    <section className="py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-12 lg:mb-16">
          <span className="text-sm font-medium text-gold-600 dark:text-gold-400 uppercase tracking-wider">Our People</span>
            ...
            >
              <div className="relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-4 gap-2">
                  <a href={`mailto:${attorney.email}`} className="w-8 h-8 rounded-full bg-white/90 flex items-center justify-center hover:bg-gold-400 transition-colors">
                    <Mail size={14} className="text-navy-900" />
                  </a>
                  <a href={`tel:${attorney.phone}`} className="w-8 h-8 rounded-full bg-white/90 flex items-center justify-center hover:bg-gold-400 transition-colors">
                    <Phone size={14} className="text-navy-900" />
                  </a>
                </div>
              </div>
              <div className="p-5">
                <h3 className="font-semibold text-navy-800 dark:text-white">{attorney.name}</h3>
                <p className="text-sm text-gold-600 dark:text-gold-400 font-medium">{attorney.title}</p>
