...
const values = [
  {
    icon: Shield,
    title: "Excellence",
    desc: "Delivering the highest quality legal services through rigorous research and strategic thinking.",
  },
  {
    icon: Gavel,
    title: "Integrity",
    desc: "Upholding the highest ethical standards in every matter we handle.",
  },
  {
    icon: BookOpen,
    title: "Expertise",
    desc: "Deep specialized knowledge across all areas of corporate and commercial law.",
  },
  {
    icon: Handshake,
    title: "Partnership",
    desc: "Building lasting relationships through collaborative and client-focused service.",
  },
];
    ...
    <section className="py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div>
            <span className="text-sm font-medium text-gold-600 dark:text-gold-400 uppercase tracking-wider">About Us</span>
          ...
          <div className="grid grid-cols-2 gap-4">
            {values.map((v) => (
              <div key={v.title} className="bg-white dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 p-5 hover:shadow-md transition-shadow">
                <div className="w-10 h-10 rounded-lg bg-navy-100 dark:bg-navy-800 flex items-center justify-center mb-3">
                  <v.icon size={20} className="text-navy-700 dark:text-navy-300" />
                </div>
                <h3 className="font-semibold text-navy-800 dark:text-white text-sm">{v.title}</h3>
